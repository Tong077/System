                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="department" id="department"
                            ...
                            value="{{ old('department', $link->department) }}" required>
                        @error('department')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea name="description" id="description"
                            ...
                            rows="1">{{ old('description', $link->description) }}</textarea>
                        @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        @enderror
                        <div class="mt-2">
                            <img id="previewImage" src="{{ $link->image ? asset('storage/'.$link->image) : '#' }}"
                                 alt="Preview"
                                 style="{{ $link->image ? 'display:block;' : 'display:none;' }} width:120px; height:120px; object-fit:cover; border-radius:8px;">
                        </div>
                    </div>
                </div>
